...
function MusicPlayer({ song, imgSrc, auto }) {
  ...
  const calculateTime = (sec) => {
    ...
    // if it is less than 10 mins, 09, 08 07 etc. else, 10, 11, 12
  ...
  return (
    <div className="musicPlayer">
      <div className="songImage">
        <img src={imgSrc} alt="music image" />
      </div>
      <div className="songAttributes">
        ...
        <div className="top">
          <div className="left">
            {/* ------ if current song playing is favourite ---- */}
            <div className="loved" onClick={changeFavSong}>
              {isFav ? (
                <i>
                  <FaRegHeart />
                </i>
          ...
          <div className="middle">
            ...
            {/* ----------if the song is playing, pause on click -------*/}
